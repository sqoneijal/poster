            ...
            <Card className="rounded-0 w-100">
               ...
               <Card.Body className="hover-scroll-overlay-y">
                  ...
                  <Editor
                     ...
                     value={h.parse("content", input)}
                     onEditorChange={(newValue) => setInput((prev) => ({ ...prev, content: newValue }))}
                     init={{
                        menubar: false,
                        ...
                        toolbar:
                           "undo redo | blocks fontfamily fontsize | bold italic underline strikethrough | align numlist bullist | link image | table media | lineheight outdent indent| forecolor backcolor removeformat | charmap emoticons | code fullscreen preview | pagebreak codesample",
                        content_style: "body { font-family:Helvetica Neue; font-size:20px }",
                     }}
                  />
               </Card.Body>
