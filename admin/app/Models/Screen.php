...
class Screen extends Common
{
   ...
   public function submit(array $post): array
   {
      ...
      try {
         $fields = ['kode', 'nama', 'screen_rotation', 'screen_animation'];
   ...
   private function queryData(): object
   {
      ...
      $this->prepareDatatableColumnSearch($table, ['kode', 'nama']);
      $this->prepareDatatableColumnOrder($table, ['kode', 'nama', 'screen_rotation', 'screen_animation']);
